...
/*
 * original
 * https://github.com/YukiMatsumura/Now/blob/master/app/src/test/java/yuki/m/android/now/time/Jsr310TimeRule.java
 *
...
public class Jsr310TimeRule implements TestRule {
    ...
    private void lockCurrentTime(long now) {
    ...
    private long parse(String iso8601z) {
        return ZonedDateTime
                .parse(iso8601z,
                        DateTimeFormatter.ISO_INSTANT.withZone(ZoneOffset.systemDefault()))
                .toInstant()
                .toEpochMilli();
    }
}
